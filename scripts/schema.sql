...
CREATE TABLE `item` (
  ...
  CONSTRAINT `FKd1g72rrhgq1sf7m4uwfvuhlhe` FOREIGN KEY (`product_id`) REFERENCES `product` (`product_id`)
...
CREATE TABLE `product_category` (
  ...
  KEY `FK6v6bsqh4sxqcnn6bclf753n76` (`user_id`),
  CONSTRAINT `FK6v6bsqh4sxqcnn6bclf753n76` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-12-20 12:40:51
